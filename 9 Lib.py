...
def __zadacha4_1__():
    ...
    def poisk_coeff(lst_x, lst_y):
        ...
        for i in range(len(lst_coeff) - 1):
            if lst_coeff[i] != 0:
                stroka_lagr += f'({lst_coeff[i]})*' + f'x**{len(lst_coeff) -\
                    i - 1} +'
        if lst_coeff[-1] != 0:
...
def __zadacha5_4__():
    ...
    def haar_wavelet(lst):
        ...
        print(f"Коэффициент несинусоидальности {(d1 ** 2 + d2 ** 2 + d3 ** 2\
              + d4 ** 2) ** 0.5 / da}")
...
def __zadacha5_5__():
    ...
    def db_wavelet(lst):
        ...
        print(f"Коэффициент несинусоидальности {(d1 ** 2 + d2 ** 2 + d3 **\
              2 + d4 ** 2) ** 0.5 / da}")
...
def __zadacha5_7__():
    ...
    def coeficcient(y, name_sample):
        for wev in ['haar', 'db2']:
            ...
            print(f" {name_sample} : Коэфф. несин. {wev} = {(d1 ** 2 + d2 **\
                  2 + d3 ** 2 + d4 ** 2) ** 0.5 / da}")
